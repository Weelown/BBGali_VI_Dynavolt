...
private:
	...
	unsigned char Direction_Pin_TX;
	unsigned char Direction_Pin_RX;
	...
	void switchCom(unsigned char Mode);
	
public:
	
	void begin(long baud, unsigned char txEN, unsigned char rxEN);
