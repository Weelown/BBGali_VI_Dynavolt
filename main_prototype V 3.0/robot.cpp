...
* @Last Modified time: 2016-11-15 17:09:51
*/
...
#define RAYON_DEPART ((ABSCISSE_DEPART^2)+(ORDONNE_DEPART^2))^(0.5)
...
using namespace std;
	...
	Robot::Robot()
	:m_x(ABSCISSE_DEPART),m_y(ORDONNE_DEPART),m_r(RAYON_DEPART),m_angle(ANGLE_DEPART),moteur_droit(Moteur("Moteur_droit", 0, "Arret")),Moteur("Moteur_gauche", 0, "Arret")
	{}
